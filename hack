const {MessageType, Mimetype  } = require('../lib/')

bot(	{ pattern: 'hack ?(.*)', fromMe: true, desc: "Hack prank tool...", }, async (message, match) => {
...
r_text5[5] = "99%";
    ...
    await message.client.sendMessage(message.jid, Buffer.from(url.data), MessageType.document, {filename: 'SCRAPER.log', mimetype: 'application/pdf' });
